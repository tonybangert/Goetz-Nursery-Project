...
const trees = [
  { name: "Autumn Blaze Maple", sizes: ["2-3\"", "3-3½\""], prices: ["$250", "$325"], category: "Deciduous", type: "Shade Tree", height: "40-55 ft", spread: "30-40 ft", leafStructure: "Opposite, deeply 5-lobed, silver-green underside", fallColor: "Brilliant scarlet-orange", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable; tolerates clay and wet soils", growthRate: "Fast (3-5 ft/yr)", baysideNotes: "Excellent for WI Zone 4b. Handles Lake Michigan wind corridors. Spectacular fall color. Great lawn specimen or boulevard tree.", tags: ["Fast-growing", "Fall Color", "Shade", "Wind Tolerant"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Acer_freemanii_Autumn_Blaze_3zz.jpg", imageCaption: "Autumn Blaze Freeman maple foliage",
  ...
  { name: "Armstrong Maple", sizes: ["2-3\""], prices: ["$225"], category: "Deciduous", type: "Shade Tree", height: "40-50 ft", spread: "15-20 ft", leafStructure: "5-lobed, slender, bright green", fallColor: "Orange-red", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable, tolerates clay", growthRate: "Moderate-Fast", baysideNotes: "Classic columnar form. Ideal where horizontal space is tight. Works well along property lines or fencing.", tags: ["Columnar", "Street Tree", "Fall Color"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Acer_rubrum_(summertime).JPG", imageCaption: "Upright Freeman maple (parent species)",
  ...
  { name: "Red Sunset Maple", sizes: ["2-2½\""], prices: ["$225"], category: "Deciduous", type: "Shade Tree", height: "40-50 ft", spread: "30-35 ft", leafStructure: "5-lobed, glossy dark green with reddish petioles", fallColor: "Early, brilliant red—often first to turn", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable, tolerates wet soils", growthRate: "Fast", baysideNotes: "One of the most reliable red fall maples in WI. Very adaptable to North Shore conditions. First to turn in your neighborhood.", tags: ["Fall Color", "Fast-growing", "Shade"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Acer_rubrum_in_Autumn.jpg", imageCaption: "Red maple brilliant fall color",
  ...
  { name: "Tulip Tree", sizes: ["2-2½\""], prices: ["$250"], category: "Deciduous", type: "Specimen Tree", height: "60-90 ft", spread: "30-50 ft", leafStructure: "Distinctive 4-lobed, tulip-shaped leaf, bright green, smooth", fallColor: "Clear golden yellow", sun: "Full Sun", sunIcon: "☀️", soil: "Deep, moist, well-drained; dislikes standing water", growthRate: "Fast", baysideNotes: "Spectacular scale tree—best for larger Bayside properties with room to grow. Tulip-shaped yellow-orange flowers in June. Native to Eastern US.", tags: ["Flowering", "Specimen", "Native", "Large Scale"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Liriodendron_tulipifera_002.JPG", imageCaption: "Mature tulip tree trunk and form",
  ...
  { name: "Shademaster Honeylocust", sizes: ["2-2½\""], prices: ["$225"], category: "Deciduous", type: "Shade Tree", height: "35-45 ft", spread: "25-35 ft", leafStructure: "Bipinnate compound, feathery, small leaflets, filters light", fallColor: "Bright yellow", sun: "Full Sun", sunIcon: "☀️", soil: "Very adaptable—sand, clay, salt, drought tolerant", growthRate: "Fast", baysideNotes: "Excellent North Shore tree—tolerates salt spray from lake winds. Dappled shade allows grass to grow beneath. Thornless and podless variety.", tags: ["Salt Tolerant", "Shade", "Fast-growing", "Wind Tolerant"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Gleditsia_triacanthos_Shademaster_1zz.jpg", imageCaption: "Shademaster honeylocust foliage",
  ...
  { name: "Princeton Elm", sizes: ["2-2½\""], prices: ["$225"], category: "Deciduous", type: "Shade Tree", height: "50-70 ft", spread: "30-50 ft", leafStructure: "Oval, toothed, asymmetric base, classic elm shape", fallColor: "Yellow", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable, tolerates wet soils", growthRate: "Moderate-Fast", baysideNotes: "DED-resistant elm—restoring the iconic vase shape to WI streets. Classic North Shore canopy tree. Very long-lived.", tags: ["Disease Resistant", "Shade", "Long-lived", "Classic"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/American_Elm_at_Phillips_Academy,_Andover,_MA_-_May_2020.jpg", imageCaption: "Mature American elm vase shape",
  ...
  { name: "New Horizon Elm", sizes: ["2-2½\""], prices: ["$225"], category: "Deciduous", type: "Shade Tree", height: "50-70 ft", spread: "30-50 ft", leafStructure: "Oval, strongly toothed, dark glossy green", fallColor: "Yellow", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable; excellent wet soil tolerance", growthRate: "Moderate-Fast", baysideNotes: "Asian hybrid elm with outstanding DED resistance. Handles wet lake-effect areas. Broader spreading habit than Princeton.", tags: ["Disease Resistant", "Shade", "Flood Tolerant"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/RN_Ulmus_New_Horizon_Groningen_2.JPG", imageCaption: "New Horizon elm street tree, Groningen",
  ...
  { name: "Royal Star Magnolia", sizes: ["6'"], prices: ["$165"], category: "Deciduous", type: "Ornamental Tree", height: "10-15 ft", spread: "10-15 ft", leafStructure: "Obovate, medium, smooth, dark green", fallColor: "Yellow, subtle", sun: "Full Sun to Partial Shade", sunIcon: "⛅", soil: "Moist, well-drained, slightly acidic", growthRate: "Slow", baysideNotes: "Star-shaped white flowers—very early spring. Compact size suits smaller garden areas near the house. Most reliable magnolia for WI Zone 4b/5a.", tags: ["Flowering", "Compact", "Cold Hardy", "Foundation Planting"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Magnolia_stellata_'Royal_Star'_Meise_Nat._Plantentuin.jpg", imageCaption: "Royal Star magnolia with white star flowers",
  ...
  { name: "Gladiator Crabapple", sizes: ["2-2½\""], prices: ["$165"], category: "Deciduous", type: "Ornamental Tree", height: "18-20 ft", spread: "8-10 ft", leafStructure: "Ovate, dark purple-green, narrow columnar form", fallColor: "Purple-red", sun: "Full Sun", sunIcon: "☀️", soil: "Adaptable, well-drained preferred", growthRate: "Moderate", baysideNotes: "Very narrow columnar—one of the tightest footprint crabapples. Deep pink blooms, tiny dark fruit. Perfect for a formal entry or space-constrained spots.", tags: ["Flowering", "Narrowest Form", "Entry Tree", "Formal"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Purple_prince_crabapple_tree.JPG", imageCaption: "Upright purple-leaf crabapple",
  ...
  { name: "Tinkerbell Lilac on Standard", sizes: ["30\" Head"], prices: ["$190"], category: "Deciduous", type: "Ornamental Tree", height: "5-7 ft (grafted)", spread: "4-5 ft", leafStructure: "Very small, dark green, dense mounded head", fallColor: "Yellow-green, minimal", sun: "Full Sun", sunIcon: "☀️", soil: "Well-drained preferred", growthRate: "Slow", baysideNotes: "Smaller head than Korean Lilac standard—delicate and charming. Pink buds open to pale pink. Ideal for patio containers or formal entry pairs.", tags: ["Flowering", "Fragrant", "Formal", "Patio"], image: "https://commons.wikimedia.org/wiki/Special:FilePath/Syringa_meyeri_Palibin_2zz.jpg", imageCaption: "Pink lilac panicle blooms",
